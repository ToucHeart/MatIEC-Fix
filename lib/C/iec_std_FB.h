...
/* NOTE: The code in this file was generated by iec2c (i.e.  C compiler), using as source
 ...
 *                     ^^^^^^
 * 
 * NOTE: If the structure of the C code generated by iec2c () should change, then this C 'library'
 ...
 *       the build process (i.e. after compiling ), but we will leave this for later if it ever
 *       becomes necessary.
 * 
